...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                "/auth/**",                          // login
                                "/api/v1/quantities/auth/**",        // signup
                                "/api/v1/quantities/perform",        // public conversions/operations
                                "/h2-console/**",
                                "/v3/api-docs/**",
                                "/swagger-ui/**",
                                "/swagger-ui.html",
                        ...
                        .anyRequest().authenticated()               // history and others stay protected
                )
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // For JWT Authorization header, credentials are not required.
